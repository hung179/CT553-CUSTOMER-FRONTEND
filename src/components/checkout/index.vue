                            ...
                            <div v-for="(item, index) in selectedProducts" :key="index" 
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div v-for="image in item.sanPham.images.filter(img => img.loaiAnh === 'DAIDIEN')"
                                        :key="image.idImg" class="w-20 h-20 bg-gray-100 rounded-xl overflow-hidden flex-shrink-0">
                                ...
                                <div v-if="savedAddresses.length > 0" class="space-y-4">
                                    ...
                                    <div class="space-y-3 max-h-64 overflow-y-auto pr-2">
                                        <div v-for="(address, index) in savedAddresses.slice(0, 5)" :key="index"
                                            ...
                                            <div class="border-2 rounded-xl p-4 transition-all duration-200 hover:shadow-lg" :class="{
                                    ...
                                    <div class="mt-6 bg-white rounded-xl p-4 shadow-sm">
                                        ...
                                        <div class="bg-emerald-50 border border-emerald-200 rounded-lg p-3">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <div class="font-medium text-emerald-800">Thanh toán trực tuyến</div>
                                                    <div class="text-xs text-emerald-600 mt-0.5">Thanh toán an toàn và nhanh chóng</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="border-t bg-gray-50 px-6 py-4 flex-shrink-0">
                    <div class="flex flex-col sm:flex-row justify-end gap-3">
                        ...
                        <button @click="placeOrder" :disabled="isPlacingOrder"
                            ...
                            <svg v-if="isPlacingOrder" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
